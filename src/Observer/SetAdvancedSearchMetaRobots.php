...
/**
 * Set NOINDEX,FOLLOW for advanced search results
 */
class SetAdvancedSearchMetaRobots implements ObserverInterface
{
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $this->logger->debug('FlipDev_Seo: Set NOINDEX for advanced search');
        } catch (\Exception $e) {
            $this->logger->error('FlipDev_Seo: Advanced search robots failed', [
