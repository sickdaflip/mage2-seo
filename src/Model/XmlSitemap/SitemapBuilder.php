    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <div class="footer">This XML sitemap helps search engines discover and index pages on your website.</div>
            </body>
        </html>
    </xsl:template>
