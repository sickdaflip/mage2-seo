        ...
        <html>
            ...
            <body>
                <div class="header">
                    ...
                    <p style="font-size:13px;opacity:.8">Author: Philipp Breitsprecher | <a href="https://github.com/sickdaflip">github.com/sickdaflip</a></p>
                </div>
                <div class="container"><xsl:apply-templates/></div>
                <div class="footer">This XML sitemap helps search engines discover and index pages on your website.<br/>FlipDev SEO by <a href="mailto:philippbreitsprecher@gmail.com">Philipp Breitsprecher</a> | <a href="https://github.com/sickdaflip/mage2-seo">GitHub</a></div>
            </body>
        </html>
    </xsl:template>
